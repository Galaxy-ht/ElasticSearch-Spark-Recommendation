...
public class AlsRecallTrain implements Serializable {
    ...
    public static void main(String[] args) throws IOException {
        ...
        JavaRDD<String> csvFile = spark.read().textFile("file://D:/project/Search-and-Recommendation/doc/data/feature.csv").toJavaRDD();
        ...
        //保存数据模型
        alsModel.save("file:///D:/project/Search-and-Recommendation/doc/data/alsmodel");
    }
